                ...
                return (
                  <div
                    ...
                    className={`relative flex flex-col bg-[#11121a] rounded-2xl overflow-hidden shadow-sm cursor-pointer transition-colors ${
                      isSelected ? "bg-[#1b1320]" : "hover:bg-[#151622]"
                    }`}
                  >
                    {isSelected && (
                      <div className="absolute bottom-2 right-2 w-6 h-6 rounded-full bg-pink-500 flex items-center justify-center text-[10px] font-bold">
                        +1
                      </div>
                    )}
                    {p.image_url && (
                    ...
                    <div className="flex-1 flex flex-col px-3 py-3 gap-2">
                      ...
                      <div className="flex justify-end mt-2">
                        <button className="px-3 py-1.5 bg-pink-600 hover:bg-pink-500 text-white rounded-lg text-xs font-medium transition-colors">
                          Select Size
                        </button>
                      </div>
                    </div>
