  ...
  const hotels = [
    {
      ...
      discount: "72% off",
      image:
        "https://images.oyoroomscdn.com/uploads/hotel_image/234771/medium/2f17106093158309.jpg",
      vendor: "Booking.com",
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <div className={`${hotel.vendorColor} font-bold text-sm`}>
                          {hotel.vendor}
                        </div>
                        <span className="bg-green-600 text-[10px] px-1.5 py-0.5 rounded text-white">
                          {hotel.discount}
                        </span>
                      </div>
                    </div>
